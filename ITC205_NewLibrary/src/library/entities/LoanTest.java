...
public class LoanTest {
	...
	public static void setUpBeforeClass() throws Exception {
		Book b1= new Book("Amritesh", "Welcome to JUnit testing", "123456", 9999);
		Book b2= new Book("Amritesh", "Welcome to JUnit testing", "123456", 00023);

		Member m1= new Member("Amritesh","Moudgil","123456","amoudgil@gmail.com",1234);
	...
	public void testGetID() {
		Member m= new Member("Amritesh","Moudgil","123456","amoudgil@gmail.com",2222);
		int id= m.getID();
