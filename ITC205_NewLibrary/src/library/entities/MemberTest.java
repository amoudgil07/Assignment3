...
public class MemberTest {
	...
	public void setUp() throws Exception {
		mem1 = new Member("Amritesh", "Moudgil", "12345", "amoudgil@gmail.com", 101);
		mem2 = new Member("Navinder", "Atwal", "54321", "natwal@gmail.com", 102);
		mem3 = new Member("Akashdeep", "Sadiora", "98765", "asadiora@gmail.com", 103);
	...
	public final void testGetFirstName() {
		...
		assertEquals("Matching First Name", "Amritesh", fName);
	}
	...
	public final void testGetLastName() {
		...
		assertEquals("Matching Last Name", "Moudgil", lName);
	}
	...
	public final void testGetEmailAddress() {
		...
		assertEquals("Matching email", "amoudgil@gmail.com", email);
	}
